        ...
        <AnimatedPage>
            <div className="grow m-8 flex flex-col items-center justify-center">
                <p className="w-full lg:w-1/2 text-center text-2xl">
                    My name is Makary Pagacz. I'm from Poland and I'm 24 years old. I graduated from
                    WSB University in Wrocław in 2021 earning Bachelor's degree. During studies I
                    realized I'm interested in Web Development.
                </p>
                <p className="text-2xl my-6">Skills and Technologies I know:</p>
                <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-12 gap-y-4">
                    <div className="w-28 h-28 flex justify-center items-center flex-col">
                        ...
                        />
                        <p className="visible peer-hover:invisible duration-100 text-center">
                            HTML
                        </p>
                    </div>
                    <div className="w-28 h-28 flex justify-center items-center flex-col">
